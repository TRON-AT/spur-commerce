    ...
    <section className="py-24 bg-background">
      <div className="mx-auto max-w-6xl px-8">
        <div className="text-center mb-16 space-y-4">
          <span className="text-sm font-medium tracking-widest text-accent uppercase">Curated Selection</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {products.map((product) => (
            ...
            >
              ...
              <div className="h-64 bg-gradient-to-br from-primary/10 via-secondary/10 to-accent/10 flex items-center justify-center border-b border-border/30 group-hover:from-primary/20 group-hover:to-accent/20 transition-all duration-300">
                <div className="text-center">
                  <div className="text-6xl font-light text-foreground/20 group-hover:text-accent/30 transition-colors">●</div>
                </div>
              </div>
              ...
              <div className="p-8 space-y-4">
                ...
                <div className="flex items-center justify-between pt-6 border-t border-border/20">
                  ...
                  <button className="px-6 py-2.5 bg-accent text-accent-foreground text-sm font-semibold rounded-lg hover:shadow-lg hover:scale-105 transition-all duration-300">
                    Add
                  </button>
                </div>
              </div>
