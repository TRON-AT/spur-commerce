export function Hero() {
  return (
    <section className="relative bg-background py-20 md:py-32 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-4 md:px-8 flex items-center justify-center text-center space-y-8">
        <div className="space-y-6 md:space-y-8">
          <div className="inline-block">
            <span className="text-xs md:text-sm font-medium tracking-widest text-accent uppercase">Premium Collection</span>
          </div>
          ...
          <button className="inline-flex px-6 md:px-8 py-3 md:py-4 bg-accent text-accent-foreground font-semibold rounded-lg hover:shadow-lg hover:scale-105 transition-all duration-300">
            Shop Collection
          </button>
        </div>
      </div>
